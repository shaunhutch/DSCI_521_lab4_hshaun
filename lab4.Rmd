...
<https://pages.github.ubc.ca/hshaun/DSCI_lab4_hshaun1/>
...
I have used the code chunk option echo, which hides the code chunk from the HTML and only shows the output.
