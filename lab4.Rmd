...
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_hshaun>
...
<https://shaunhutch.github.io/DSCI_521_lab4_hshaun/>
...
I have used the code chunk option echo, which hides the code chunk from
the HTML and only shows the output.

```{r Question 4 answer, echo = FALSE}
a <- 5
b <- 10
c <- (a**2 + b**2 )**0.5
c
...
```{r Question 5 Answer, message=FALSE, results='hide'}
a <- 5
b <- 10
c <- (a**2 + b**2 )**0.5
c
print("This message should not print")
...
7.1
<https://github.com/shaunhutch/DSCI_521_lab4_hshaun/blob/master/question7.html>

7.2
<https://github.com/shaunhutch/DSCI_521_lab4_hshaun/blob/master/question7.pdf>
...
Question 8 rmd:
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_hshaun/blob/master/question8.Rmd>

Question 8 html
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_hshaun/blob/master/question8.html>
...
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_hshaun/blob/master/question8.md>

This file is rendered like an HTML document in github. Normally, when
you upload an HTML document to github, you only see the code. So this is
an easier to view document for github.
